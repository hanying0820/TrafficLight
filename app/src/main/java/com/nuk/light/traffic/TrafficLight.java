...
public class TrafficLight {
     ...
     * */
    TrafficLight(int id, Cursor period) {
        Id = id;
        mPeriod = period;

        /* 取得現在時間 */
        String rightNow = new SimpleDateFormat("HH:mm:ss", Locale.TAIWAN).format(Calendar.getInstance().getTime());
    ...
    /* 回傳是否紅燈剩五秒需要提醒 */
    public boolean isNeededReminding(String second) {
