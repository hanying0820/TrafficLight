...
public class MainActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        final ImageView iv_Setting = findViewById(R.id.setting);
                ...
                switch (message.what) {
                    case Action.SET_TRAFFIC_LIGHT:
                        ...
                        switch (mMyService.getStatus()) {
                            case "Green":
                                iv_TrafficLight.setImageResource(R.drawable.green);

                                break;
                            case "Red":
                                iv_TrafficLight.setImageResource(R.drawable.red);

                                break;
                            case "Yellow":
                                iv_TrafficLight.setImageResource(R.drawable.yellow);
